...
public class OttoCachedField<RETURN_TYPE> extends CachedFieldImpl<RETURN_TYPE> {
    ...
    public OttoCachedField(Provider<String> sessionIdProvider, Provider<RETURN_TYPE> valueGetter, ResponseEvent<RETURN_TYPE> successEvent, Object errorEvent, final Bus bus) {
